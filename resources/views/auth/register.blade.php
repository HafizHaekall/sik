...
<head>
    ...
    <title>Register | Sistem Informasi Kasir</title>
  ...
  <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
    ...
    @csrf
        <div>
            ...
            <div class="mt-2">
            <input id="name" name="name" type="name" autocomplete="name" required class="block w-full rounded-md border-0 py-1.5 px-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
            </div>
        </div>
    ...
    <p class="text-center mt-10">Sudah punya akun? <a class="underline text-[blue] hover:text-black" href="{{ route('login') }}">Log in</a> disini!</p>
  </div>
</div>
</body>
</html>
